...
/**
 * Mobile OAuth landing — return 200 with ?code= in the URL.
 * The in-app browser captures this URL and closes; never redirect to web /inbox.
 * PKCE exchange happens inside the native app.
 */
