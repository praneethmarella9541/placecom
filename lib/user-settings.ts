...
const NOTIFY_KEY = "gmail_extract_notify_complete";

export function getNotifyOnExtractionCompleteSetting(): boolean {
...
export function setNotifyOnExtractionCompleteSetting(notify: boolean) {
