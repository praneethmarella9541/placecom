...
/**
 * POST-only twin of `DELETE /api/sheets/[id]/link-share`, for the
 ...
 * fires the same revoke. See app/(workspace)/sheets/[id]/page.tsx.
 */
export async function POST(
  ...
  try {
    ...
    console.error(`[link-share/revoke] ${spreadsheetId}: ${err.code || err.message}`);
