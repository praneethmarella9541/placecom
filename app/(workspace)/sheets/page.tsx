...
import { Frame, Loader2, Plus, Search } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
        ...
        <form data-testid="sheets-create-form" onSubmit={(e) => void handleCreate(e)} className="flex flex-col gap-3 sm:flex-row sm:items-center">
          <input
            data-testid="sheets-new-title-input"
            id="new-sheet-title"
            type="text"
            value={title}
